...
$\bar{Y}_t - \bar{Y}_c$ is the average effect under the treated subjects and the untreated subjects. When we calculate this value for all possible assignments $Z$, then we get a distribution for $\bar{Y}_t - \bar{Y}_c$. Under $H_0$, which assuming that there is $0$ treatment effect for an observed treatment assignment $Z_1$,  



> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjc0MDgzNTgzLC0yMDY5NzA4NTQ1XX0=
-->