...
In the later section of the video, a more valid $H_0$ is given that $H_0: \tau=1, H_1: \tau>1$ where ${y}_i(1) - y_i(0)=\tau$ and now everything start to make sense. Under the $H_0$, from the observed data we have $(y_1(0) = 1, y_2(0)=3, y_3(0)=3, y_4(0)=5)$ and $(y_1(0) = 2, y_2(0)=4, y_3(0)=4, y_4(0)=6)$. This way we can calculate the distribution of $\bar{Y}_1 - \bar{Y}_0$  

> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDg0Njg0MjIsMTUwODUzNjEwMCwtMT
